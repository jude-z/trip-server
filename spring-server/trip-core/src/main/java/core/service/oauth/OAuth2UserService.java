package core.service.oauth;

import core.api.security.oauth.userdetail.CustomOAuth2User;
...
import core.infra.jpa.member.SocialRepository;
...
public class OAuth2UserService extends DefaultOAuth2UserService {
    ...
    private Member findOrCreateMember(String email, String nickname, String oauthClientName) {
        // 기존 회원 조회
        Optional<Member> existingMember = queryDslMemberRepository.findByEmail(email);
