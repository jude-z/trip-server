...
public enum Status {
    ...
    OAUTH_DENIED("OD", "OAuth Access Denied", HttpStatus.FORBIDDEN),
    OAUTH_SERVER_ERROR("OS", "OAuth Server Error", HttpStatus.BAD_GATEWAY),
    REDIS_SERVER_ERROR("RS", "Redis Server Error", HttpStatus.BAD_GATEWAY),
    OAUTH_INVALID_CLIENT("OI", "OAuth Invalid Client", HttpStatus.UNAUTHORIZED),
